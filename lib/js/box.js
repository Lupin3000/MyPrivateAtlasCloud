...
$(document).ready(function() {
  ...
  var list_boxes = function() {
    $.getJSON('boxlist.php', {_: new Date().getTime()}, function(data) {
      console.log("JSON Data: ", data);
      $.each(data, function(i, field) {
        if (typeof field === 'object') {
          var info = info_link(field);
          var del = '<a title="Delete this box" class="button del_btn" data-name="' + field.name + '" data-url="' + field.file + '"><i class="fas fa-trash"></i></a>';
